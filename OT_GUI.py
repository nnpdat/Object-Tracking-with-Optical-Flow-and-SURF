...
class Ui_Dialog(object):
        ...
        while (True):
            ...
            if ret:
                ...
                if self.Pause.isChecked():
                    ...
                    while not (self.Start.isChecked()):
                        if self.key2 == ord('r'):
                        ...
                        self.key2 = cv2.waitKey(25)
                        continue
                if self.Reset.isChecked():
                    self.Reset.toggle()
                    self.click_count = 0
                    self.tracker_enabled = False
                    self.error = None
                if self.Exit.isChecked():  # 13 is the Enter Key
                    break
        sys.exit(app.exec_())
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(618, 92)
        self.groupBox_2 = QtWidgets.QGroupBox(Dialog)
        self.groupBox_2.setGeometry(QtCore.QRect(30, 20, 571, 51))
        self.groupBox_2.setObjectName("groupBox_2")
        self.Pause = QtWidgets.QPushButton(self.groupBox_2)
        self.Pause.setGeometry(QtCore.QRect(150, 20, 75, 23))
        self.Pause.setObjectName("Pause")
        self.Reset = QtWidgets.QPushButton(self.groupBox_2)
        self.Reset.setGeometry(QtCore.QRect(290, 20, 75, 23))
        self.Reset.setObjectName("Reset")
        self.Exit = QtWidgets.QPushButton(self.groupBox_2)
        self.Exit.setGeometry(QtCore.QRect(450, 20, 75, 23))
        self.Exit.setObjectName("Exit")
        self.Start = QtWidgets.QPushButton(self.groupBox_2)
        self.Start.setGeometry(QtCore.QRect(20, 20, 75, 23))
